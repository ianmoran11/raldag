...
z <- v("z", .f = d(~ rnorm(n = 1, mean = rsum(.x), sd = 0)))
x <- v("x", .f = d(~ rnorm(n = 1, mean = rsum(.x), sd = 0)))
y <- v("y", .f = d(~ rnorm(n = 1, mean = rsum(.x), sd = 0)))
...
t1 <- v("t1", .f = d(~ rnorm(n = 1, mean = rsum(.x), sd =  0)))
t2 <- v("t2", .f = d(~ rnorm(n = 1, mean = rsum(.x), sd =  0)))
t3 <- v("t3", .f = d(~ rnorm(n = 1, mean = rsum(.x), sd =  0)))
t4 <- v("t4", .f = d(~ rnorm(n = 1, mean = rsum(.x), sd =  0)))
t5 <- v("t5", .f = d(~ rnorm(n = 1, mean = rsum(.x), sd =  0)))
